...
rows <- list(
  ...
  list(lab = "Top-5 journal",                 type = "prop",
  ...
  list(lab = "Field journal",                 type = "prop",
...
tex <- c(
  ...
  "\\footnotesize",
  paste0(
    "\\item \\textit{Notes.} The comparison pool contains 484 manually validated ",
    "DiD articles that are not part of the reanalyzed sample. Proportion differences ",
    "use two-sample $\\chi^2$ tests, and publication year uses Welch's $t$-test. ",
    "Three reanalyzed articles added after the original master list are excluded ",
    "from this exercise. Journal coding for the comparison pool relies on the raw ",
    "master file and likely under-reports AEJ and \\emph{Review of Economics and ",
    "Statistics} among non-reanalyzed articles."),
  "\\end{tablenotes}",
  "\\end{threeparttable}",
  "\\end{table}")
